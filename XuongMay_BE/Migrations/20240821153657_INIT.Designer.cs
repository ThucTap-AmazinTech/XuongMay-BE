...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("XuongMay_BE.Contract.Repositories.Entities.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("XuongMay_BE.Contract.Repositories.Entities.Order", b =>
                {
                    b.HasOne("XuongMay_BE.Contract.Repositories.Entities.Customer", null)
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("XuongMay_BE.Contract.Repositories.Entities.Tasks", b =>
                {
                    b.HasOne("XuongMay_BE.Contract.Repositories.Entities.Order", null)
                        .WithMany("Tasks")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("XuongMay_BE.Contract.Repositories.Entities.Product", null)
                        .WithMany("Tasks")
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("XuongMay_BE.Contract.Repositories.Entities.ProductionLine", null)
                        .WithMany("Tasks")
