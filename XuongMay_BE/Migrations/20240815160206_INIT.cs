        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductionLines_User_UserId",
                        column: x => x.UserId,
                        principalTable: "User",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderDetels", x => x.Order_ID);
                    table.ForeignKey(
                        name: "FK_OrderDetels_Orders_OrderId",
                        column: x => x.OrderId,
                        principalTable: "Orders",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_OrderDetels_Products_ProductId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderDetels_OrderId",
                table: "OrderDetels",
                column: "OrderId");

            migrationBuilder.CreateIndex(
                name: "IX_OrderDetels_ProductId",
                table: "OrderDetels",
                column: "ProductId");
